...
<form action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
    <div class="container" style="width:50vw;">
        <h1 style="text-align:center; font-size:36px; font-weight:700; padding-top:50px; padding-bottom:20px;">商品を出品</h1>
        @csrf
        ...
        <div class="mb-3">
            ...
            <div class="image-upload-area" >
                ...
                <button type="button" onclick="document.getElementById('imageInput').click()" class="image-upload-button">画像を選択する</button>
            </div>
        </div>


    <h2 style="color:#5f5f5f; font-weight:700; border-bottom: 1px solid #5f5f5f; padding-bottom:10px; margin-top:50px;">
        商品の詳細</h2>
    <div class="mb-3">
